    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'modules' => ['accounting', 'approvals', 'billing', 'bi', 'carousels', 'document', 'fleet', 'inventory', 'invoicing', 'maintenance', 'orders', 'outbound', 'pages', 'partners', 'payables', 'pos', 'posts', 'products', 'promotions', 'purchasing', 'receivables', 'routing', 'sales', 'scoring', 'tracking', 'transportation'],
                'sort_order' => 3,
                'is_default' => false,
            ],
        ];
