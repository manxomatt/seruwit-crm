    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'modules' => ['approvals', 'billing', 'carousels', 'document', 'fleet', 'inventory', 'invoicing', 'maintenance', 'orders', 'outbound', 'pages', 'partners', 'posts', 'products', 'purchasing', 'receivables', 'routing', 'tracking', 'transportation'],
                'sort_order' => 3,
                'is_default' => false,
            ],
        ];
