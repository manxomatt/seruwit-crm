  ...
  return (
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h2 className="text-5xl font-black text-slate-900 mb-8 font-display">Ready to Start Your Joyful Journey?</h2>
        <p className="text-2xl text-slate-600 mb-12 leading-relaxed">
          Join thousands of families and businesses finding peace of mind with our playful and powerful GPS technology.
        </p>
