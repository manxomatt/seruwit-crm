...
const featureKeys = ['contacts', 'pipeline', 'analytics', 'tasks', 'collaboration', 'security'] as const;
const highlightKeys = ['contacts', 'uptime', 'setup'] as const;
...
const Features: React.FC = () => {
  ...
  const highlights = highlightKeys.map((key) => ({
    key,
    value: t(`landing.features.highlights.${key}.value`),
    label: t(`landing.features.highlights.${key}.label`),
  }));
      ...
      <section className="bg-slate-50 py-24" id="fitur">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-sky-500">{t('landing.features.eyebrow')}</p>
