...
export default function Editor({ page }: Props): JSX.Element {
    ...
    const saveContent = useCallback(async () => {
        ...
        try {
            ...
            await fetch(route('pages.save-content', page.id), {
                method: 'PATCH',
                headers: {
                ...
                <div className="bg-gray-800 text-white px-4 py-2 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            onClick={saveContent}
                            disabled={isSaving}
                            className="bg-blue-600 hover:bg-blue-700 px-4 py-1.5 rounded text-sm font-medium transition disabled:opacity-50"
                        >
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="bg-gray-600 hover:bg-gray-700 px-4 py-1.5 rounded text-sm font-medium transition"
                        >
                            Preview
                        </Link>
                    </div>
