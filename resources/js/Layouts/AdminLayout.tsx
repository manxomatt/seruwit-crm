        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {sidebarOpen && (
                <div className="fixed inset-0 z-40 lg:hidden">
                    ...
                    />
                    <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-gradient-to-b from-indigo-700 to-indigo-900">
            ...
            <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
                <div className="flex min-h-0 flex-1 flex-col bg-gradient-to-b from-indigo-700 to-indigo-900">
                    <div className="flex h-16 items-center px-4 border-b border-indigo-600">
                        <Link href="/" className="flex items-center">
                            <ApplicationLogo className="h-8 w-auto text-white" />
                            <span className="ml-2 text-xl font-bold text-white">Admin</span>
                        </Link>
