...
const MENU_GROUPS: MenuGroup[] = [
    ...
    { titleKey: 'procurement_warehouse', modules: ['purchasing', 'sales', 'inventory', 'receivables', 'payables'] },
    ...
    { titleKey: 'sales_commercial', modules: ['pos', 'canvassing', 'rental', 'promotions'] },
...
const moduleRouteMap: Record<string, { route: string; routePattern: string }> = {
    ...
    'payables': { route: 'module.payables.bills.index', routePattern: 'module.payables.*' },
