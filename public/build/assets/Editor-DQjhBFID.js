import{r as a,j as t,H as y,L as g,c as m}from"./app-iMa_CisK.js";import{_ as w,g as x,a as h}from"./index-D1Y3X01K.js";/* empty css            */function C({page:o}){const l=a.useRef(null),[n,f]=a.useState(null),[d,p]=a.useState(!1),[c,b]=a.useState(null),s=a.useCallback(async()=>{if(n){p(!0);try{const i=n.getHtml(),e=n.getCss(),r=n.getProjectData();await fetch(route("module.pages.save-content",o.id),{method:"PATCH",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":document.querySelector('meta[name="csrf-token"]')?.getAttribute("content")||"",Accept:"application/json"},body:JSON.stringify({html:i,css:e,gjs_data:r})}),b(new Date)}catch(i){console.error("Failed to save:",i)}finally{p(!1)}}},[n,o.id]);a.useEffect(()=>{if(!l.current)return;const i=w.init({container:l.current,height:"100%",width:"auto",storageManager:!1,plugins:[x,h],pluginsOpts:{[x]:{blocks:["column1","column2","column3","column3-7","text","link","image","video","map"],flexGrid:!0},[h]:{blocksBasicOpts:!0,navbarOpts:!0,countdownOpts:!0,formsOpts:!0}},canvas:{styles:["https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css"],scripts:[],frameStyle:`
                    html, body {
            ...
            `,attributes:{class:"fa fa-images"}}),i.DomComponents.addType("carousel-component",{isComponent:r=>r.tagName==="DIV"&&r.classList.contains("carousel-wrapper"),model:{defaults:{tagName:"div",droppable:!1,attributes:{class:"carousel-wrapper"},traits:[{type:"text",name:"slug",label:"Carousel Slug",placeholder:"Enter carousel slug"}]},init(){this.on("change:attributes:slug",this.updateCarouselSlug)},updateCarouselSlug(){const u=`<Carousel slug="${this.getAttributes().slug||"test-carousel"}" />`;this.components(u)}},view:{onRender(){const r=this.model.getAttributes().slug||"test-carousel";this.el.innerHTML=`
                    ...
                    `}}}),f(i),()=>{i.destroy()}},[o]),a.useEffect(()=>{if(!n)return;const i=setInterval(()=>{s()},3e4);return()=>clearInterval(i)},[n,s]),a.useEffect(()=>{const i=e=>{(e.ctrlKey||e.metaKey)&&e.key==="s"&&(e.preventDefault(),s())};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[s]);const v=()=>{m.patch(route("module.pages.update",o.id),{is_published:!o.is_published},{preserveScroll:!0})};return t.jsxs(t.Fragment,{children:[t.jsx(y,{title:`Edit: ${o.title}`}),t.jsxs("div",{className:"h-screen flex flex-col",children:[t.jsxs("div",{className:"bg-gradient-to-r from-indigo-700 to-indigo-900 text-white px-4 py-2 flex items-center justify-between shadow-lg",children:[t.jsxs("div",{className:"flex items-center gap-4",children:[t.jsxs(g,{href:route("module.pages.index"),className:"text-indigo-200 hover:text-white transition flex items-center gap-2",children:[t.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10 19l-7-7m0 0l7-7m-7 7h18"})}),"Back to Pages"]}),t.jsx("span",{className:"text-indigo-400",children:"|"}),t.jsx("span",{className:"font-medium",children:o.title})]}),t.jsx("div",{className:"panel__devices flex items-center gap-2"}),t.jsxs("div",{className:"flex items-center gap-4",children:[c&&t.jsxs("span",{className:"text-indigo-200 text-sm",children:["Last saved: ",c.toLocaleTimeString()]}),t.jsx("button",{onClick:s,disabled:d,className:"bg-white/10 hover:bg-white/20 backdrop-blur-sm px-4 py-1.5 rounded-lg text-sm font-medium transition disabled:opacity-50 border border-white/20",children:d?"Saving...":"Save"}),t.jsx("button",{onClick:v,className:`px-4 py-1.5 rounded-lg text-sm font-medium transition ${o.is_published?"bg-yellow-500 hover:bg-yellow-600 text-white":"bg-green-500 hover:bg-green-600 text-white"}`,children:o.is_published?"Unpublish":"Publish"}),t.jsx(g,{href:route("module.pages.show",o.id),target:"_blank",className:"bg-white/10 hover:bg-white/20 backdrop-blur-sm px-4 py-1.5 rounded-lg text-sm font-medium transition border border-white/20",children:"Preview"})]})]}),t.jsx("div",{className:"flex-1 overflow-hidden",children:t.jsx("div",{ref:l,className:"h-full"})})]}),t.jsx("style",{children:`
                .gjs-one-bg {
