...
return [
    ...
    'subscription' => [
        ...
        'heading' => 'Tiered Pricing by Fleet Scale',
        'heading_description' => 'The more vehicles registered in the system, the more cost-effective each unit becomes automatically without rigid plan commitments.',
        'payg_badge' => '⚡ Pay As You Go (PAYG)',
        'manage_fleet' => '⚡ Manage Fleet',
        'manage_fleet_renew' => '⚡ Manage Fleet & Renew',
        'collapse' => 'Collapse',
        'expand' => 'View Details',
        'current_tier' => 'Your Active Tier',
        'per_vehicle' => '/vehicle',
        'per_vehicle_per_month' => '/ unit / mo',
        'rate_per_vehicle' => 'Effective Rate per Unit',
        'monthly_estimate' => 'Monthly Investment Estimate',
        'vehicles' => 'vehicles',
        ...
        'next_tier_unlock' => 'Unlock Better Savings on the Next Tier:',
        'next_tier_progress' => 'Progress to',
        'next_tier_desc' => 'Add :count more vehicles to enjoy the discounted rate of :price/unit/month.',
        'simulator_title' => 'Fleet Cost Estimation Simulator',
        'simulator_subtitle' => 'Drag the slider or choose quick presets to simulate rate calculations and savings.',
        'simulated_count_label' => 'Simulated Fleet Size:',
        'unit' => 'Units',
        'reset' => 'Reset',
        'quick_select' => 'Quick Presets:',
        'my_fleet' => 'My Fleet (:count Units)',
        'simulated_tier_label' => 'Simulated Tier:',
        'monthly' => 'Monthly',
        'annual' => 'Annual',
        'total_annual' => 'Annual Total (-20%):',
        'total_monthly' => 'Monthly Estimate:',
        'annual_equivalent' => '(Equivalent to :price/month)',
        'annual_equivalent_note' => ':price / mo (billed annually)',
        'all_modules_active' => 'All modules & features active',
        'tier_list_title' => 'Volume Pricing Tier Directory',
        'tier_list_subtitle' => 'Click on any tier card to instantly simulate costs at that fleet scale.',
        'tiers_available' => ':count Rate Levels Available',
        'simulated_badge' => '🎯 Simulated',
        'save_percent' => 'Save :percent%',
        'view_billing' => 'View Billing & Subscription Details →',
        'transparency_note' => 'No hidden licensing fees. Flexible Pay-As-You-Go scheme applies per active unit.',
    ],
