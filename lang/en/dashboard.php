...
return [
    ...
    'onboarding' => [
        ...
        'title' => 'Set Up Your Fleet & Business Contacts',
        'desc' => 'Register your fleet vehicles and customer/vendor contacts to enable automated rental bookings, live GPS tracking, and invoicing.',
        'progress_label' => 'Core Data Setup Progress',
        'step_fleet_title' => '1. Register Fleet Vehicles',
        'step_fleet_desc' => 'Add your cars, buses, or trucks with license plate, vehicle model, and seat/cargo capacity.',
        'step_fleet_cta' => 'Add Vehicle',
        'step_fleet_view' => 'View Fleet',
        'step_fleet_empty' => 'No Vehicles Yet',
        'step_fleet_done' => ':count Vehicle(s) Registered',
        'step_partners_title' => '2. Register Contacts & Partners',
        'step_partners_desc' => 'Add individual or corporate clients, fleet drivers, repair vendors, or business partners.',
        'step_partners_cta' => 'Add Contact',
        'step_partners_view' => 'View Contacts',
        'step_partners_empty' => 'No Contacts Yet',
        'step_partners_done' => ':count Contact(s) Registered',
        'benefits_title' => 'Features Unlocked Once Setup is Complete:',
        'benefit_rental' => 'Rental Bookings & Invoicing',
        'benefit_rental_desc' => 'Select vehicles and clients seamlessly when creating rental contracts.',
        'benefit_tracking' => 'Live GPS Tracking & Telemetry',
        'benefit_tracking_desc' => 'Track vehicle positions, speeds, and ignition status on the live map.',
        'benefit_finance' => 'Accounting & Partner Statements',
        'benefit_finance_desc' => 'Keep full financial audit trails, invoice balances, and transaction statements.',
    ],
