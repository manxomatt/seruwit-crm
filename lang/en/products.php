...
return [
    ...
    'dashboard' => [
        ...
        'subtitle' => 'Catalog overview — active items, category mix, brand coverage, and records that need attention.',
        'active' => 'Active products',
        'of_products' => 'of :total products',
        'share_label' => 'of catalog',
        'favorites' => 'Favorites',
        'favorites_hint' => 'Pinned for quick access',
        'variants' => 'Variants',
        'variants_hint' => 'Child SKUs under a parent',
        'brands' => 'Active brands',
        'of_brands' => 'of :total brands',
        'brands_ready' => 'ready to assign',
        'principals_short' => 'principals',
        'needs_attention' => 'Needs attention',
        'needs_attention_hint' => 'Inactive, missing brand, or missing price',
        'without_brand' => 'no brand',
        'without_price' => 'no price',
        'catalog_masters' => 'Catalog masters',
        'top_brands' => 'Top brands',
        'manage_brands' => 'Manage brands',
        'no_brands' => 'No branded products yet.',
