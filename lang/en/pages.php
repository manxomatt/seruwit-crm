...
return [
    ...
    'index' => [
        ...
        'set_homepage_title' => 'Set Main Homepage',
        'set_homepage_confirm' => 'Are you sure you want to set ":title" as the main homepage? Visitors will see this page when opening your site domain.',
        'set_homepage_confirm_generic' => 'Are you sure you want to set this page as the main homepage?',
