...
return [
    ...
    'dashboard' => [
        ...
        'onboarding' => [
            'badge' => 'GPS & TRACKING SETUP GUIDE',
            'title' => 'Connect GPS Data Source & Activate Fleet Telematics',
            'description' => 'Integrate Traccar, Sky Track, or another GPS server to track fleet movement in real-time, record route history, manage geofences, and evaluate driver safety.',
            'banner_title' => 'GPS Tracking Setup Incomplete',
            'banner_desc' => 'Complete the configuration of :missing to fully unlock the live map and telemetry features.',
            'progress' => ':completed of :total Steps Completed (:percent%)',
            'next_step' => 'Next Step',
            'step_pending' => 'Pending Configuration',
            'step_completed' => '✓ Completed',
            'step1_title' => '1. GPS Data Source & Provider',
            'step1_desc' => 'Connect your Traccar, Sky Track, or GPS-Server to pull vehicle coordinate data and device telemetry.',
            'step1_cta_add' => 'Connect GPS Source',
            'step1_cta_manage' => 'Manage GPS Sources',
            'step1_status' => ':count Source(s) Connected',
            'step2_title' => '2. Sync GPS Tracker Devices',
            'step2_desc' => 'Import and sync your registered GPS tracker devices from the provider to start receiving live coordinates.',
            'step2_cta_sync' => 'Sync Devices',
            'step2_cta_manage' => 'Manage Devices',
            'step2_status' => ':count Device(s) Detected',
            'step3_title' => '3. Pair Trackers to Vehicles',
            'step3_desc' => 'Pair GPS tracker devices to fleet vehicle units so that speed, live location, and odometer sync automatically.',
            'step3_cta_pair' => 'Pair Tracker to Unit',
            'step3_cta_manage' => 'View Pairing Status',
            'step3_status' => ':count Device(s) Paired',
            'why_setup_title' => 'Features Unlocked After GPS Setup',
            'why_map_title' => 'Real-Time Live Fleet Map',
            'why_map_desc' => 'Monitor the exact location and movement of your entire fleet in real-time with motion status (moving/idle/stale).',
            'why_history_title' => 'Route History & Playback',
            'why_history_desc' => 'Replay past fleet travel trails, analyze driving speeds, and inspect vehicle stopping points.',
            'why_geofence_title' => 'Geofences & Zone Alerts',
            'why_geofence_desc' => 'Receive automated alerts whenever vehicles enter or exit defined depot and operational boundaries.',
            'why_scoring_title' => 'Driver Behavior Scoring',
            'why_scoring_desc' => 'Automatically detect harsh braking, overspeeding, and excessive idling to rate driver safety performance.',
        ],
    ],
