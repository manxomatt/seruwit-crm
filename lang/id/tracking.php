...
return [
    ...
    'dashboard' => [
        ...
        'onboarding' => [
            'badge' => 'PANDUAN KONEKSI GPS & TRACKING',
            'title' => 'Hubungkan Sumber Data GPS & Aktifkan Telemetri Armada',
            'description' => 'Integrasikan GPS Traccar, Sky Track, atau server GPS lainnya untuk memantau pergerakan armada secara real-time, merekam jejak rute, geofencing, dan evaluasi perilaku pengemudi.',
            'banner_title' => 'Setup Tracking GPS Belum Selesai',
            'banner_desc' => 'Lengkapi konfigurasi :missing untuk mengaktifkan peta live dan telemetri armada secara optimal.',
            'progress' => ':completed dari :total Langkah Selesai (:percent%)',
            'next_step' => 'Langkah Selanjutnya',
            'step_pending' => 'Perlu Dikonfigurasi',
            'step_completed' => '✓ Selesai',
            'step1_title' => '1. Sumber Data & Provider GPS',
            'step1_desc' => 'Hubungkan server Traccar, Sky Track, atau GPS-Server untuk menarik data koordinat dan telemetri perangkat.',
            'step1_cta_add' => 'Hubungkan Sumber GPS',
            'step1_cta_manage' => 'Kelola Sumber GPS',
            'step1_status' => ':count Sumber Terhubung',
            'step2_title' => '2. Sinkronisasi Perangkat GPS',
            'step2_desc' => 'Impor dan sinkronkan daftar tracker GPS yang terdaftar pada provider untuk mulai menerima sinyal koordinat.',
            'step2_cta_sync' => 'Sinkronkan Perangkat',
            'step2_cta_manage' => 'Kelola Perangkat',
            'step2_status' => ':count Perangkat Terdeteksi',
            'step3_title' => '3. Hubungkan Tracker ke Kendaraan',
            'step3_desc' => 'Pairing perangkat GPS ke unit kendaraan armada agar data kecepatan, lokasi, dan odometer terhubung otomatis.',
            'step3_cta_pair' => 'Pair Tracker ke Unit',
            'step3_cta_manage' => 'Lihat Status Pairing',
            'step3_status' => ':count Perangkat Ter-Pair',
            'why_setup_title' => 'Fitur Otomatis yang Terbuka Setelah Terhubung GPS',
            'why_map_title' => 'Peta Armada Real-Time',
            'why_map_desc' => 'Pantau lokasi dan pergerakan seluruh armada kendaraan secara live dengan status mesin (bergerak/idle/stale).',
            'why_history_title' => 'Riwayat Rute & Playback',
            'why_history_desc' => 'Putar ulang rekam jejak perjalanan armada, analisis kecepatan berkendara, dan titik pemberhentian unit.',
            'why_geofence_title' => 'Geofence & Alert Zona',
            'why_geofence_desc' => 'Dapatkan notifikasi otomatis saat kendaraan keluar atau masuk area pool dan wilayah yang ditentukan.',
            'why_scoring_title' => 'Scoring Perilaku Pengemudi',
            'why_scoring_desc' => 'Deteksi otomatis pengereman mendadak (harsh brake), kecepatan tinggi, dan idle untuk penilaian driver.',
        ],
    ],
