...
return [
    ...
    'dashboard' => [
        ...
        'subtitle' => 'Ringkasan katalog — produk aktif, bauran kategori, cakupan merek, dan data yang perlu perhatian.',
        'active' => 'Produk aktif',
        'of_products' => 'dari :total produk',
        'share_label' => 'dari katalog',
        'favorites' => 'Favorit',
        'favorites_hint' => 'Dipin untuk akses cepat',
        'variants' => 'Varian',
        'variants_hint' => 'SKU anak di bawah parent',
        'brands' => 'Merek aktif',
        'of_brands' => 'dari :total merek',
        'brands_ready' => 'siap dipakai',
        'principals_short' => 'principal',
        'needs_attention' => 'Perlu perhatian',
        'needs_attention_hint' => 'Nonaktif, tanpa merek, atau tanpa harga',
        'without_brand' => 'tanpa merek',
        'without_price' => 'tanpa harga',
        'catalog_masters' => 'Master katalog',
        'top_brands' => 'Merek teratas',
        'manage_brands' => 'Kelola merek',
        'no_brands' => 'Belum ada produk ber-merek.',
