...
return [
    ...
    'fields' => [
        ...
        'badge_placeholder' => 'Contoh: Paling Populer, Hemat 20%',
        'is_popular' => 'Tandai sebagai Paket Unggulan / Populer',
        'is_popular_hint' => 'Memberikan aksen border, warna khusus, dan ribbon pada halaman langganan tenant.',
        'max_vehicles' => 'Maksimal Armada Kendaraan',
        'max_vehicles_hint' => '0 atau kosong = Tanpa Batas (Unlimited)',
        'max_users' => 'Maksimal Akun Pengguna / Staf',
        'max_users_hint' => '0 atau kosong = Tanpa Batas (Unlimited)',
        'max_branches' => 'Maksimal Cabang / Pool',
        'max_branches_hint' => '0 atau kosong = Tanpa Batas (Unlimited)',
        'features_list' => 'Poin-Poin Fitur Unggulan (Pricing Checklist)',
        'features_list_hint' => 'Poin teks yang ditampilkan di kartu harga pada halaman aktivasi tenant.',
        'add_feature' => 'Tambah Poin Fitur',
        'feature_placeholder' => 'Contoh: Kontrak & Invoicing Otomatis',
