...
class ModulePageEntrypointTest extends TestCase
{
    ...
    public function test_every_resolved_entrypoint_is_a_file_that_exists(): void
    {
        $components = [
            ...
            'Modules/Fleet/Bases/Index',
            'Modules/Fleet/Bases/Create',
            'Modules/Fleet/Bases/Edit',
            'Modules/Fleet/Bases/Show',
            ...
            'Modules/Posts/Edit',
            'Modules/Posts/Show',
            'Modules/Receivables/Payments/Index',
            'Modules/Receivables/Payments/Create',
            'Modules/Receivables/Payments/Show',
            'Modules/Receivables/Aging/Index',
            'Modules/Receivables/Credit/Index',
            'Modules/Outbound/PickLists/Index',
            'Modules/Outbound/PickLists/Create',
            'Modules/Outbound/PickLists/Show',
            'Modules/Outbound/Packs/Create',
            'Modules/Outbound/Packs/Show',
            'Modules/Outbound/Packs/Label',
