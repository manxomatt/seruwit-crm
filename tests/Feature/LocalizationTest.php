    ...
    public function test_fleet_translations_follow_selected_locale(): void
    {
        ...
        $this->get(route('login'))
            ...
            ->assertInertia(fn ($page) => $page
                ...
                ->where('translations.landing.nav.features', 'Modules')
                ->where('translations.landing.hero.title_highlight', 'one workspace')
                ...
                ->where('translations.tracking.actions.sync', 'Sync devices')
        ...
        $this->get(route('login'))
            ...
            ->assertInertia(fn ($page) => $page
                ...
                ->where('translations.landing.hero.title_highlight', 'satu workspace')
                ->where('translations.live_updates.title', 'Live Updates')
                ...
                ->where('translations.tracking.nav.map', 'Live Map')
                ->where('translations.tracking.actions.sync', 'Sinkronisasi perangkat')
