    ...
    public function test_super_admin_sees_plans_with_their_modules_and_tenant_counts(): void
    {
        ...
        $this->actingAs($admin)->get('/module/plans')
            ...
            ->assertInertia(fn ($page) => $page
                ...
                ->where('availableModules.5.key', 'invoicing')
                ->where('availableModules.6.key', 'maintenance')
                ->where('availableModules.7.key', 'orders')
                ->where('availableModules.8.key', 'pages')
                ->where('availableModules.9.key', 'posts')
                ->where('availableModules.10.key', 'products')
                ->where('availableModules.11.key', 'tracking')
                ->where('availableModules.12.key', 'transportation')
