                    ...
                    <form onSubmit={submit} className="max-w-3xl space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 border-t pt-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <Select id="unit" className="mt-1" value={data.unit} onChange={(value) => setData('unit', value)} placeholder={t('products.fields.unit')}
                        ...
                        <div className="flex items-center gap-4">
                            <PrimaryButton disabled={processing}>{t('products.products.create.submit')}</PrimaryButton>
