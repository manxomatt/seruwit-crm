...
export default function Create({ parentOptions }: Props): JSX.Element {
    ...
    return (
        <DynamicLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">{t('products.product_types.create.title')}</h2>}>
            <Head title={t('products.product_types.create.title')} />
            <ProductNav />
                ...
                <div className="p-6">
                    <form onSubmit={submit} className="max-w-xl space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            <PrimaryButton disabled={processing}>{t('products.product_types.create.submit')}</PrimaryButton>
