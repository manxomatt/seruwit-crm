                                            ...
                                            <tr key={customer.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                                    <div className="flex items-center justify-end gap-3">
                                                        <Link href={prefixedRoute('customers.show', customer.id)} className="text-gray-600 hover:text-gray-900">
                                                            View
                                                        </Link>
                                                        {can.update && (
                                                            <Link href={prefixedRoute('customers.edit', customer.id)} className="text-indigo-600 hover:text-indigo-900">
                                                                Edit
                                                            </Link>
                                                        )}
                                                        {can.delete && (
                                                            <button onClick={() => openDeleteDialog(customer)} className="text-red-600 hover:text-red-900">
                                                                Delete
                                                            </button>
                                                        )}
                                                    </div>
