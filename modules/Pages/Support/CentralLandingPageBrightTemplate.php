...
class CentralLandingPageBrightTemplate
{
    /**
     * Build the data array for the Soft & Bright Central Landing Page variant.
     *
...
.srw-bright-root {
    ...
    --srw-bg-card: #ffffff;
    --srw-bg-soft: #f1f5f9;
    --srw-bg-indigo-light: #eef2ff;
    --srw-bg-emerald-light: #ecfdf5;
    --srw-bg-cyan-light: #ecfeff;
    
    --srw-indigo: #4f46e5;
    --srw-indigo-dark: #3730a3;
    --srw-cyan: #06b6d4;
    --srw-emerald: #10b981;
    --srw-rose: #f43f5e;
    
    --srw-grad-primary: linear-gradient(135deg, #4f46e5 0%, #2563eb 100%);
    --srw-grad-soft-hero: radial-gradient(circle at 50% -20%, rgba(99, 102, 241, 0.12) 0%, transparent 70%),
                          radial-gradient(circle at 85% 40%, rgba(6, 182, 212, 0.1) 0%, transparent 50%),
                          radial-gradient(circle at 15% 80%, rgba(244, 63, 94, 0.08) 0%, transparent 50%);
    --srw-grad-text: linear-gradient(135deg, #4f46e5 0%, #06b6d4 60%, #10b981 100%);
...
.srw-bright-root *, 
.srw-bright-root *::before, 
.srw-bright-root *::after {
...
.srw-btn-login:hover {
    background: var(--srw-bg-indigo-light);
    color: var(--srw-indigo) !important;
}
.srw-btn-portal {
    background: var(--srw-grad-primary);
...
.srw-hero {
    ...
    background: var(--srw-grad-soft-hero), var(--srw-bg-base);
    width: 100%;
}
.srw-hero-grid {
    display: flex;
...
.srw-btn-secondary:hover {
    ...
    border-color: var(--srw-border-soft);
...
.srw-icon-cyan { background: linear-gradient(135deg, #0284c7, #06b6d4); box-shadow: 0 6px 18px rgba(6, 182, 212, 0.35); }
.srw-icon-emerald { background: linear-gradient(135deg, #059669, #10b981); box-shadow: 0 6px 18px rgba(16, 185, 129, 0.35); }
.srw-icon-amber { background: linear-gradient(135deg, #d97706, #f59e0b); box-shadow: 0 6px 18px rgba(245, 158, 11, 0.35); }
.srw-icon-indigo { background: linear-gradient(135deg, #4f46e5, #818cf8); box-shadow: 0 6px 18px rgba(79, 70, 229, 0.35); }
...
.srw-price-card.featured {
    border: 2px solid var(--srw-indigo);
...
.srw-btn-plan-outline {
    ...
    color: var(--srw-indigo) !important;
    border: 1.5px solid var(--srw-indigo);
}
...
.srw-btn-plan-solid:hover {
    transform: translateY(-2px);
    box-shadow: 0 10px 28px rgba(79, 70, 229, 0.52);
}
    ...
    <div class="srw-hero-grid">
      <div class="srw-hero-content">
        <div class="srw-pill-badge">
          <span class="srw-pill-dot"></span> Platform CRM &amp; ERP Cerah &amp; Modern
        </div>
        <h1 class="srw-hero-title">
          Kelola Operasional <span>Bisnis Anda Lebih Cepat &amp; Efisien</span>
        </h1>
        <p class="srw-hero-subtitle">
          Solusi terpadu modular untuk manajemen persediaan barang, pengadaan, penjualan, armada logistik, hingga otomatisasi pembukuan akuntansi.
        </p>
        ...
        <div class="srw-dashboard-card">
          <div class="srw-card-header">
            <div class="srw-card-title">
              <span class="srw-live-indicator"></span> Business Performance Center
            </div>
            <span style="color:#4f46e5; font-size:0.78rem; font-weight:800;">Realtime Monitor</span>
          </div>
          
          <div class="srw-stats-mini-grid">
            <div class="srw-mini-stat">
              <div class="srw-mini-label">Pendapatan Bulan Ini</div>
              <div class="srw-mini-val">Rp 3.12B</div>
              <div class="srw-mini-trend">↑ +24.8% bertumbuh</div>
            </div>
            <div class="srw-mini-stat">
              <div class="srw-mini-label">Modul Aktif</div>
              <div class="srw-mini-val">15 Modul</div>
              <div class="srw-mini-trend" style="color:#059669;">Semua Terintegrasi</div>
            </div>
          </div>
          
          <div class="srw-module-bars">
            <div class="srw-bar-item">
              <div class="srw-bar-info"><span>Stok Gudang &amp; Inventory</span><span>96% Optimal</span></div>
              <div class="srw-bar-bg"><div class="srw-bar-fill" style="width: 96%;"></div></div>
            </div>
            <div class="srw-bar-item">
              <div class="srw-bar-info"><span>Penjualan &amp; POS Kasir</span><span>98.5% Transaksi Sukses</span></div>
              <div class="srw-bar-bg"><div class="srw-bar-fill" style="width: 98%; background: linear-gradient(90deg, #10b981, #34d399);"></div></div>
            </div>
            <div class="srw-bar-item">
              <div class="srw-bar-info"><span>Pelacakan Armada &amp; Pengiriman</span><span>92% On-Time</span></div>
              <div class="srw-bar-bg"><div class="srw-bar-fill" style="width: 92%; background: linear-gradient(90deg, #0284c7, #38bdf8);"></div></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="srw-container">
    <div class="srw-metrics-grid">
      <div>
        ...
        <div class="srw-metric-lbl">Transaksi Terproses Harian</div>
      </div>
      <div>
        <div class="srw-metric-num">99.99<span>%</span></div>
        <div class="srw-metric-lbl">Reliabilitas Sistem SLA</div>
      </div>
      <div>
        <div class="srw-metric-num">15<span>+</span></div>
        <div class="srw-metric-lbl">Modul Siap Pakai</div>
      </div>
      <div>
        <div class="srw-metric-num">500<span>+</span></div>
        <div class="srw-metric-lbl">Perusahaan Terdaftar</div>
      </div>
    </div>
  </div>
</section>
...
<section class="srw-section srw-section-white" id="modul">
  <div class="srw-container">
    <div class="srw-head">
      ...
      <p class="srw-head-sub">Pilih modul yang dibutuhkan untuk operasional perusahaan Anda tanpa kerumitan.</p>
    </div>
    ...
    <div class="srw-suites-grid">
      ...
      <div class="srw-suite-card">
        ...
        <p class="srw-suite-desc">Kelola persediaan barang di berbagai lokasi gudang, sistem pengadaan (Purchasing), manajemen armada kendaraan, dan pelacakan rute GPS real-time.</p>
      ...
      <div class="srw-suite-card">
        ...
        <p class="srw-suite-desc">Kelola alur transaksi penjualan dari tim canvassing lapangan, kasir Point of Sale (POS), promo perdagangan, hingga manajemen pesanan otomatis.</p>
        <div class="srw-tags-wrap">
      ...
      <div class="srw-suite-card">
        ...
        <p class="srw-suite-desc">Penerbitan faktur otomatis, manajemen piutang pelanggan (Receivables), utang usaha (Payables), serta pembukuan Buku Besar terintegrasi.</p>
        <div class="srw-tags-wrap">
      ...
      <div class="srw-suite-card">
        ...
        <p class="srw-suite-desc">Persetujuan bertingkat (Workflow Approvals), pusat penyimpanan dokumen legal, analitik bisnis, dan Executive Dashboard eksekutif.</p>
        <div class="srw-tags-wrap">
  ...
  <div class="srw-container">
    ...
    <div class="srw-feat-grid">
      <div class="srw-feat-card">
        ...
        <p class="srw-feat-desc">Isolasi data workspace secara terpisah dengan keamanan tinggi dan performa mandiri.</p>
      </div>

      <div class="srw-feat-card">
        <div class="srw-feat-icon">🧩</div>
        <h3 class="srw-feat-title">Modular Flexibility</h3>
        <p class="srw-feat-desc">Aktifkan atau nonaktifkan modul secara instan sesuai kebutuhan tanpa mengubah arsitektur.</p>
      </div>

      <div class="srw-feat-card">
        <div class="srw-feat-icon">🔒</div>
        <h3 class="srw-feat-title">Role-Based Access</h3>
        <p class="srw-feat-desc">Pengaturan hak akses bertingkat yang detail untuk menjaga privasi dokumen dan transaksi.</p>
      </div>

      <div class="srw-feat-card">
        <div class="srw-feat-icon">📍</div>
        <h3 class="srw-feat-title">Telematika GPS</h3>
        <p class="srw-feat-desc">Integrasi peta lokasi real-time untuk penentuan rute dan pelacakan posisi pengiriman.</p>
      </div>

      <div class="srw-feat-card">
        <div class="srw-feat-icon">📈</div>
        <h3 class="srw-feat-title">Laporan Analitik</h3>
        <p class="srw-feat-desc">Dashboard grafik interaktif untuk melihat pertumbuhan omset dan kinerja pengemudi secara akurat.</p>
      </div>

      <div class="srw-feat-card">
        <div class="srw-feat-icon">📱</div>
        <h3 class="srw-feat-title">Akses Seluler PWA</h3>
        <p class="srw-feat-desc">Tampilan responsif di Smartphone dan Tablet untuk kemudahan operasional di lapangan.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="srw-container">
    ...
    <div class="srw-steps-grid">
      <div class="srw-step-item">
        ...
        <p class="srw-step-desc">Buat akun perusahaan Anda dan dapatkan subdomain workspace khusus dalam hitungan detik.</p>
      </div>

      <div class="srw-step-item">
        <div class="srw-step-badge">2</div>
        <h3 class="srw-step-title">Aktifkan Modul</h3>
        <p class="srw-step-desc">Pilih modul bisnis yang Anda butuhkan (Inventory, Sales, Fleet, Invoicing, dll).</p>
      </div>

      <div class="srw-step-item">
        <div class="srw-step-badge">3</div>
        <h3 class="srw-step-title">Mulai Operasional</h3>
        <p class="srw-step-desc">Undang anggota tim dan mulai otomatisasi alur bisnis Anda secara terpusat.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="srw-section srw-section-soft" id="harga">
  <div class="srw-container">
    <div class="srw-head">
      ...
      <p class="srw-head-sub">Transparan tanpa biaya tersembunyi. Tingkatkan paket kapan saja.</p>
    </div>
    ...
    <div class="srw-price-grid">
      ...
      <div class="srw-price-card">
        ...
        <div class="srw-price-sub">Pilihan pas untuk bisnis berkembang.</div>
      ...
      <div class="srw-price-card featured">
        ...
        <div class="srw-price-sub">Solusi lengkap untuk logistik &amp; perdagangan.</div>
      ...
      <div class="srw-price-card">
        ...
        <div class="srw-price-sub">Untuk kustomisasi skala besar.</div>
  ...
  <div class="srw-container">
    ...
    <div class="srw-testi-grid">
      ...
      <div class="srw-testi-card">
        <div>
          <div class="srw-stars">★★★★★</div>
          <p class="srw-testi-quote">"Kasir POS dan modul persetujuan membantu pemantauan 5 outlet toko kami. Pembukuan otomatis membuat keuangan selalu rapi."</p>
        </div>
        <div class="srw-testi-user">
      ...
      <div class="srw-testi-card">
        <div>
          <div class="srw-stars">★★★★★</div>
          <p class="srw-testi-quote">"Sistem modularnya luar biasa fleksibel. Kami bisa mengaktifkan modul tambahan kapan pun bisnis membutuhkan perluasan."</p>
        </div>
        <div class="srw-testi-user">
...
<section class="srw-cta-section">
  <div class="srw-container">
    ...
    <p class="srw-cta-desc">Mulai sekarang dan nikmati otomatisasi penuh untuk rantai pasok dan penjualan perusahaan Anda.</p>
