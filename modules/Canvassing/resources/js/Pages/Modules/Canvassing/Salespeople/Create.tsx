    ...
    return (
        <DynamicLayout header={t('canvassing.title')}>
            ...
            <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <h1 className="mb-6 text-xl font-semibold text-gray-900 dark:text-white">{t('canvassing.salespeople.add')}</h1>
                <form onSubmit={submit} className="space-y-5 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        <Link href={prefixedRoute('canvassing.salespeople.index')}><SecondaryButton type="button">{t('common.cancel')}</SecondaryButton></Link>
