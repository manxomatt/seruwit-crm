    ...
    return (
        <DynamicLayout header={t('canvassing.title')}>
            ...
            <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <h1 className="mb-6 text-xl font-semibold text-gray-900 dark:text-white">{t('canvassing.salespeople.edit_head', { name: salesperson.name })}</h1>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            <label className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                ...
                                {t('canvassing.salespeople.active')}
                            </label>
                        </div>
                    </div>
                    <div className="flex justify-end gap-3 pt-2">
                        <Link href={prefixedRoute('canvassing.salespeople.show', salesperson.id)}><SecondaryButton type="button">{t('common.cancel')}</SecondaryButton></Link>
                        <PrimaryButton disabled={processing}>{t('canvassing.salespeople.save')}</PrimaryButton>
                    </div>
                </form>
            </div>
        </DynamicLayout>
