...
export default function Index({ bays, dates, cells, filters, can }: Props): JSX.Element {
    ...
    return (
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {can.create && (
                                <Link href={prefixedRoute('maintenance.work-orders.create')}>
                                    <PrimaryButton type="button">{t('maintenance.work_orders.new')}</PrimaryButton>
                                </Link>
                            )}
                        </div>
                    }
        ...
        >
            ...
            <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-900">{t('maintenance.calendar.head')}</h3>
                <p className="mt-1 text-sm text-gray-500">{t('maintenance.calendar.subtitle')}</p>
            </div>
