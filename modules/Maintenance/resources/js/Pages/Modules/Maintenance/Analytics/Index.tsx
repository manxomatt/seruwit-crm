    ...
    return (
        ...
        >
            ...
            <div className="w-full pb-12">
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-12 xl:gap-8 items-start">
                    {/* Kolom Kiri: Panel Body Content Utama */}
                        ...
                        <div className="grid gap-4 sm:grid-cols-3">
                            <div className="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-black text-slate-900 dark:text-white">👨‍🔧 Ongkos Jasa</span>
                                    <span className="text-xs font-mono text-slate-400">Labor</span>
                                </div>
                                <p className="mt-2 font-mono text-xl font-black text-indigo-600 dark:text-indigo-400">
                            ...
                            <div className="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-black text-slate-900 dark:text-white">🔩 Suku Cadang</span>
                            ...
                            <div className="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-black text-slate-900 dark:text-white">🎯 Kepatuhan</span>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2">
                            ...
                            <section className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xs dark:border-slate-800 dark:bg-slate-900 space-y-4">
                                <div className="border-b border-slate-100 pb-3 dark:border-slate-800">
                                    <h3 className="text-base font-black text-slate-900 dark:text-white">Biaya per Kategori</h3>
                                    <p className="text-xs text-slate-400">Distribusi pengeluaran kelompok perbaikan.</p>
                                </div>
                                            ...
                                            <div key={row.category_id ?? row.name} className="space-y-1.5">
                                                <div className="flex items-center justify-between gap-3 text-xs">
                                                    <span className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                                                        ...
                                                        <span className="text-[10px] text-slate-400 shrink-0">({row.work_order_count})</span>
                                                    </span>
                            ...
                            <section className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xs dark:border-slate-800 dark:bg-slate-900 space-y-4">
                                <div className="border-b border-slate-100 pb-3 dark:border-slate-800">
                                    <h3 className="text-base font-black text-slate-900 dark:text-white">Biaya per Bengkel / Vendor</h3>
                                    <p className="text-xs text-slate-400">Distribusi biaya rekanan luar & internal.</p>
                                </div>
                                            ...
                                            <div key={row.vendor_key} className="space-y-1.5">
                                                <div className="flex items-center justify-between gap-3 text-xs">
                                                    <span className="font-bold text-slate-900 dark:text-white truncate">
                                                        {row.name}
                                                        <span className="ml-1 text-[10px] text-slate-400">({row.work_order_count})</span>
                                                    </span>
                                                    <span className="font-mono font-bold text-slate-800 dark:text-slate-200 shrink-0">
                                                        {formatCurrency(row.total_cost, localeTag)}
                                                    </span>
                    ...
                    {/* Kolom Kanan: Panel AI Predictive Fleet Maintenance & Anomaly Detection */}
