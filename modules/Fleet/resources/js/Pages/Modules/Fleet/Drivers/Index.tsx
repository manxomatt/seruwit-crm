...
const menuItemClassName = 'flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold text-slate-700 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800';
const menuItemDangerClassName = 'flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-bold text-rose-600 transition hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-950/40';
                                                                ...
                                                                >
                                                                    ...
                                                                    {can.update && (
                                                                        <MenuItem>
                                                                            ...
                                                                            >
                                                                                <PencilIcon />
                                                                                <span>{t('common.edit', undefined, 'Edit Pengemudi')}</span>
                                                                            </Link>
                                                                        </MenuItem>
                                                                    )}
                                                                    {can.delete && (
                                                                        <>
                                                                            ...
                                                                            <MenuItem>
                                                                                ...
                                                                                >
                                                                                    <TrashIcon />
                                                                                    <span>{t('common.delete', undefined, 'Hapus Pengemudi')}</span>
                                                                                </button>
                                                                            </MenuItem>
                                                                        </>
                                                                    )}
