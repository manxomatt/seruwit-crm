...
export default function Create(): JSX.Element {
    ...
    return (
        <DynamicLayout
            header={
                <PageHeader
                    ...
                    subtitle="Daftarkan pengemudi operasional baru dengan foto, nomor SIM, golongan, dan informasi kontak lengkap."
                    actions={
                        <Link
        ...
        >
            <Head title="Tambah Pengemudi Baru · Fleet" />
            <FleetNav />
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 pb-28">
                ...
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <span>/</span>
                    <span className="font-bold text-slate-800 dark:text-slate-200">Tambah Pengemudi Baru</span>
                </nav>

                <form id="fleet-driver-create-form" onSubmit={submit} className="space-y-6">
                    {/* Card 1: Profil & Foto */}
                    ...
                    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200/80 bg-white/95 backdrop-blur-md px-6 py-4 shadow-lg dark:border-slate-800 dark:bg-slate-900/95">
                        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
                            <div className="flex items-center gap-2 text-xs">
                                <span className="font-black text-slate-900 dark:text-white">{data.name || 'Pengemudi Baru'}</span>
                            ...
                            <div className="flex gap-2">
                                ...
                                >
                                    {processing ? 'Menyimpan...' : '＋ Simpan Pengemudi Baru'}
                                </PrimaryButton>
                            </div>
                        </div>
                    </div>
