        ...
        <DynamicLayout
            header={
                <PageHeader
                    ...
                    subtitle={`Perbarui informasi identitas, lokasi GPS, jam operasional, dan staf penanggung jawab pool ${base.code}.`}
                    actions={
                        <Link
                        ...
                        >
                            ← Kembali ke Detail Base
                        </Link>
                    }
                />
            }
        >
            <Head title={`Edit Base · ${base.name}`} />
            <FleetNav />
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 pb-12">
                ...
                <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <span>/</span>
                    <Link href={prefixedRoute('fleet.bases.show', base.id)} className="hover:text-slate-700 dark:hover:text-slate-200">
                        {base.name}
                    </Link>
                    <span>/</span>
                ...
                <form id="fleet-base-edit-form" onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                        ...
                        >
                            {processing ? 'Menyimpan Perubahan...' : '💾 Simpan Perubahan Base'}
                        </PrimaryButton>
                    </div>
                </form>
            </div>
