...
export default function Create({ categories, calculations, directions, accounts }: Props): JSX.Element {
    ...
    const submit = (e: FormEvent) => {
        e.preventDefault();
        post(prefixedRoute('accounting.tax-codes.store'));
    };

    return (
        <AccountingShell active="tax_codes" title={t('accounting.tax.create')}>
