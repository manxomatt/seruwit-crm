...
export default function Edit({ account, types, parents }: Props): JSX.Element {
    ...
    const submit = (e: FormEvent) => {
        e.preventDefault();
        patch(prefixedRoute('accounting.accounts.update', account.id));
    };

    return (
        <AccountingShell active="accounts" title={t('accounting.accounts.edit')}>
